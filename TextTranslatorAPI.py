...
opcao = input("Diga a lingua alvo")
texto = input("Diga o texto a ser traduzido")
print(dic_final[opcao])
...
payload = {
	"source_language": "pt",
	"target_language": dic_final[opcao],
	"text": texto
}
headers = {
...
print(f"Este é seu traduzido:  {texto_traduzido}")